...
PRIORITY="optional" 
MAINTAINER="$3 <$4>" 
DEPENDS="coreutils, dialog, memtest86+, mkisofs | genisoimage, findutils, grub-pc, xorriso|syslinux, os-prober, bash, passwd, sed, squashfs-tools, live-boot, live-config, live-config-systemd, live-boot-initramfs-tools, rsync, mount, laptop-detect, util-linux, hwdata" 
SUGGESTS="respin-gui" 
